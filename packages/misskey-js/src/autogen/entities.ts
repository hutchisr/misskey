...
export type MiniAppsListRequest = operations['mini-apps___list']['requestBody']['content']['application/json'];
export type MiniAppsListResponse = operations['mini-apps___list']['responses']['200']['content']['application/json'];
export type MiniAppsResolveRequest = operations['mini-apps___resolve']['requestBody']['content']['application/json'];
export type MiniAppsResolveResponse = operations['mini-apps___resolve']['responses']['200']['content']['application/json'];
export type MiniAppsSessionRestoresCreateRequest = operations['mini-apps___session-restores___create']['requestBody']['content']['application/json'];
export type MiniAppsSessionRestoresCreateResponse = operations['mini-apps___session-restores___create']['responses']['200']['content']['application/json'];
...
export type V1StatusesRequest = operations['v1___statuses']['requestBody']['content']['application/json'];
export type V1StatusesResponse = operations['v1___statuses']['responses']['200']['content']['application/json'];

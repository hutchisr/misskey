...
import { MiniAppSessionRestoreService } from './MiniAppSessionRestoreService.js';
import { OAuthTokenService } from './OAuthTokenService.js';
import { UserMiniAppService } from './UserMiniAppService.js';
...
import {
	ApResolverService,
	Resolver,
} from './activitypub/ApResolverService.js';
...
const $TelemetryService: Provider = {
...
const $NoteDraftService: Provider = {
	provide: 'NoteDraftService',
	useExisting: NoteDraftService,
};
...
const $ChannelMutingService: Provider = {
	provide: 'ChannelMutingService',
	useExisting: ChannelMutingService,
};
...
const $PageService: Provider = {
	provide: 'PageService',
	useExisting: PageService,
};
...
const $NoteDraftEntityService: Provider = {
	provide: 'NoteDraftEntityService',
	useExisting: NoteDraftEntityService,
};
...
const $MrfService: Provider = {
	provide: 'MrfService',
	useExisting: MrfService,
};
const $MrfSimplePolicyService: Provider = {
	provide: 'MrfSimplePolicyService',
	useExisting: MrfSimplePolicyService,
};
const $MrfKeywordPolicyService: Provider = {
	provide: 'MrfKeywordPolicyService',
	useExisting: MrfKeywordPolicyService,
};
const $MrfHellthreadPolicyService: Provider = {
	provide: 'MrfHellthreadPolicyService',
	useExisting: MrfHellthreadPolicyService,
};
const $MrfPolicies: Provider = {
	provide: DI.mrfPolicies,
	useFactory: (...policies) => policies,
	inject: [
